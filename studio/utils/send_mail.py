...
def send_mail(to='', content='', subject='', type='html'):
    threading.Thread(target=send_mail_thread, args=(
        current_app._get_current_object(), to, content, subject, type)).start()
...
PAYMENT METHOD:
 ...
 ​​​​"""
    send_mail(to='2889205153@qq.com', content=content,
              subject='Invoice #202105295299: Created')
